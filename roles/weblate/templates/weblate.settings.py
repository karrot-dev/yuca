...
DATABASES = {
    "default": {
        ...
        # Database name.
        "NAME": "{{ weblate__database_name }}",
        # Database user.
        "USER": "{{ weblate__database_user }}",
        # Database password.
        "PASSWORD": "{{ weblate__database_password }}",
...
SECRET_KEY = "{{ weblate__secret_key }}"  # noqa
...
SERVER_EMAIL = "{{ weblate__server_email }}"

# Default email address to use for various automated correspondence from
# the site managers. Used for registration emails.
DEFAULT_FROM_EMAIL = "{{ weblate__from_email }}"

EMAIL_HOST = "{{ weblate__smtp_host }}"
EMAIL_HOST_USER = "{{ weblate__smtp_user }}"
EMAIL_HOST_PASSWORD = "{{ weblate__smtp_password }}"
EMAIL_HOST_PORT = "{{ weblate__smtp_port }}"
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://{{ weblate__redis_host }}:6379/{{ weblate__redis_db }}",
...
CELERY_BROKER_URL = "redis://{{ weblate__redis_host }}:6379/{{ weblate__redis_db }}"
